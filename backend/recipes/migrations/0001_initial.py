# Generated by Django 3.2.16 on 2023-01-16 14:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredient', models.ManyToManyField(help_text='Выберите ингредиенты', related_name='recipes', through='recipes.IngredientsForRecipe', to='recipes.Ingredient', verbose_name='Ингредиенты')),
            ],
            options={
                'verbose_name': 'Рецепт',
